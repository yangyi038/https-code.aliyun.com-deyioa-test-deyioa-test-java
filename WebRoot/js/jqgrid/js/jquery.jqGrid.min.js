		...
		styleUI: {
			jQueryUI: {
				...
				base: {
					...
					icon_first: "icon-double-angle-left",
					icon_prev: "icon-angle-left",
					icon_next: "icon-angle-right",
					icon_end: "icon-double-angle-right",
			...
			if(!this.grid) {
				...
				var
					...
					V = function(a, b) {
						...
						var
							h = t.indexOf(c); - 1 === h ? (t.push(c), u.push(g)) : g ? u[h] = g : (u.splice(h, 1), t.splice(h, 1)), d.p.sortorder = "", d.p.sortname = "";
						for(var
								i = 0, j = t.length; j > i; i++) i > 0 && (d.p.sortname += ", "), d.p.sortname += t[i], i !== j - 1 && (d.p.sortname += " " + u[i]);
						d.p.sortorder = u[j - 1]
					},
				...
				ra = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
					width: e.width + "px"
				...
				$(d).before(e.hDiv).click(function(a) {
					...
					if("A" !== ma.tagName && ("INPUT" !== ma.tagName && "TEXTAREA" !== ma.tagName && "OPTION" !== ma.tagName && "SELECT" !== ma.tagName || b))
						if(Ga = na[0].id, ma = $(ma).closest("tr.jqgrow>td"), ma.length > 0 && (Ha = $.jgrid.getCellIndex(ma), Ia = $(ma).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [Ga, Ha, Ia, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ga, Ha, Ia, a)), d.p.cellEdit !== !0) {
							if(c)
								if(d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", Ga, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ga).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ga)[d.p.useProp ? "prop" : "attr"]("checked", !b));
								else
							if(d.p.multiselect && d.p.multiboxonly)
								if(b) $(d).jqGrid("setSelection", Ga, !0, a);
								else {
									var
									...
									}), d.p.selarrrow = [], $(d).jqGrid("setSelection", Ga, !0, a)
								}
							else
								$(d).jqGrid("setSelection", Ga, !0, a)
						} else
					if(d.p.multiselect && b && c) $(d).jqGrid("setSelection", Ga, !0, a);
					else
					if(ma.length > 0) try {
					...
					if(ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
						...
						var
							b = $(d).triggerHandler("jqGridDblClickRow", [$(na).attr("id"), Ga, Ha, a]);
						return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(na).attr("id"), Ga, Ha, a), null != b) ? b : void
						0
					}
				}).bind("contextmenu", function(a) {
					if(ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
						d.p.multiselect || $(d).jqGrid("setSelection", na[0].id, !0, a), Ga = na[0].rowIndex, Ha = $.jgrid.getCellIndex(ma);
						var
							b = $(d).triggerHandler("jqGridRightClickRow", [$(na).attr("id"), Ga, Ha, a]);
						return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(na).attr("id"), Ga, Ha, a), null != b) ? b : void
						0
					}
				...
				var
					Ja = q + " " + k(l, "icon_caption_open", !0),
					Ka = q + " " + k(l, "icon_caption_close", !0);
				e.cDiv = document.createElement("div");
				var
					La = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
						La.addClass(o)
					}, function() {
						La.removeClass(o)
				...
				if($(e.cDiv).append(La).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
					var
						Ma = k(l, "customtoolbarBox", !0, "ui-userdata");
				...
				if(d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), U(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(Fa).width(e.width).insertAfter(e.hDiv), $(Fa).append(za), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), Ea && $(e.sDiv).hide()), Fa = null, d.p.caption) {
					...
					d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
						...
						return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), f += ", #" + $(e.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
							b--, 0 === b && ($("span", g).removeClass(Ja).addClass(Ka), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
						}) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
							b--, 0 === b && ($("span", g).removeClass(Ka).addClass(Ja), Ea && (d.p.datatype = Na, S(), Ea = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
						}), !1
					...
					if("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
							if(h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
								...
								if("_empty" === c && u.defaultValue && (k = a.isFunction(u.defaultValue) ? u.defaultValue.call(s) : u.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, u, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[h] = k), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), F) a(L).find("#" + h).replaceWith(m);
									...
									0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(t), a(e).append(j), j[0].rp = w), a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === v.label ? d.p.colNames[n] : v.label) + "</label>"), a("td:eq(" + (x - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
								}
							...
							v = a.extend({
								...
								complete: function(g, j) {
									...
									if(s.p.autoencode && a.each(u, function(b, c) {
										...
										}, 500)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (a(y).data("disabled", !1), "_empty" !== b[s.p.id]._savedData[s.p.id + "_id"]))
										for(l in
						...
						c = a.map(b[s.p.id]._savedData, function(a, b) {
							...
							if(-1 === c.indexOf(this.name)) {
								var
									e = a(this).val(),
									f = a(this).get(0).type;
								if("checkbox" === f) a(this).is(":checked") || (e = a(this).attr("offval"));
								else
								if("select-multiple" === f) e = e.join(",");
								else
								if("radio" === f) {
									if(d.hasOwnProperty(this.name)) return !0;
									d[this.name] = void
					...
					if(F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
						...
						a(s).triggerHandler("jqGridAddEditInitializeForm", [a(y), w]), a.isFunction(b[s.p.id].onInitializeForm) && b[s.p.id].onInitializeForm.call(s, a(y), w), "_empty" !== c && b[s.p.id].viewPagerButtons ? a("#pData,#nData", t).show() : a("#pData,#nData", t).hide(), a(s).triggerHandler("jqGridAddEditBeforeShowForm", [a(y), w]), a.isFunction(b[s.p.id].beforeShowForm) && b[s.p.id].beforeShowForm.call(s, a(y), w), r(), a("#" + a.jgrid.jqID(B.themodal)).data("onClose", b[s.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(B.themodal), {
							...
							if(b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
								...
								var
									c;
								if(a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(s, "next", a(y), b[1][b[0]]), void 0 !== c && c === !1)) return !1;
							...
							if(-1 !== b[0] && b[1][b[0] - 1]) {
								...
								var
									c;
								if(a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(s, "prev", a(y), b[1][b[0]]), void 0 !== c && c === !1)) return !1;
								if(a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass(h.disabled)) return !1;
