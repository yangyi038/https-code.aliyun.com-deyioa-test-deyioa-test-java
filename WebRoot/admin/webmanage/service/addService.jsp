...
height:200px;
	...
	<form action="<%=basepath%>/admin/service/addService.action" enctype="multipart/form-data" method="post"> 
      		<div class="admin-s-body block">
       		<span><b style="color: red;">*</b>标签名称</span>
       		<div class="admin-s"><input type="text" name="ser_name"   id="ser_name"/></div>
       	</div>
       	<div class="admin-s-body block ">
       		<span class="top"><b style="color: red;">*</b>标签描述:</span>
       		<div class="admin-s"><textarea rows="5" cols="90"  id="remark"  name="remark"></textarea></div>
       	</div> 
					...
					<c:if test="${meg!=null}">
						<e:msgdialog basepath="<%=basepath%>"
							callback="window.parent.closeDialogm('add_service_m');window.parent.refreshGrid('service');">
							${meg}
						</e:msgdialog>
					</c:if>
