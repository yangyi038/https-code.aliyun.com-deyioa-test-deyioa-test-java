...
height:200px;
	...
	<form action="<%=basepath%>/admin/coupon/addCoupon.action" enctype="multipart/form-data" method="post"> 
      	<div class="admin-s-body block">
       		<span><b style="color: red;">*</b>优惠券名称</span>
       		<div class="admin-s">
       		
       		<input type="text" name="cou_name"   id="cou_name"  placeholder="请输入优惠券名称"  /> 
       	</div>
       	</div>
       	<div class="admin-s-body">
       		<span><b style="color: red;">*</b>优惠券类型</span>
       		<div class="admin-s">  
			        			 <select name="ctype" id="ctype" onchange="yhtype()">
      	...
      	<div class="admin-s-body block">
       		...
       		<input type="text" name="issuenum"   id="issuenum"  placeholder="请输入发行数量"  /> 
       	</div>
       	</div>
       	...
       	<div class="admin-s-body block none" id="dk"  >
       		...
       		<div class="admin-s"> 
       		<input type="text" name="cou_money_dk"   id="cou_money"  placeholder="请输入优惠所值金额"    />
       		 </div>
       		</div>
       		...
       		<div class="admin-s">
       		满
       		<input type="text" name="min_goods_amount"   id="min_goods_amount"  placeholder="请输入使用金额限制"   style="width:145px;margin:0 8px"/>
       		减
       		<input type="text" name="cou_money"   id="cou_money"  placeholder="请输入优惠所值金额"   style="width:144px;margin:0 8px"/>
       		...
       		<div class="admin-s"> 
       		<input type="text" name="rebate"   id="rebate"  placeholder="请输入使用金额限制"     onblur="zk()"/>(0.1为1折，以此类推)
       		 </div>
       		</div>
    	 	...
    	 	<div class="admin-s-body block"  >
       		...
       		<div class="admin-s"><input type="text" name="use_start_date"  id="use_start_date"  placeholder="请输入开始时间"   onclick="WdatePicker()"/></div>---
       		<div class="admin-s"><input type="text" name="use_end_date"  id="use_end_date"  placeholder="请输入结束时间"  onclick="WdatePicker()"  /></div>
       	</div>   
       	<div class="admin-s-body block"  >
       	...
       	<div class="admin-s-body  block"  >
       		...
       		<div class="admin-s"><textarea rows="5" cols="50" placeholder="请输入备注"  name="remarks"   id="remarks"></textarea>
       	</div> 	 
       	</div>  
					...
					<c:if test="${meg!=null}">
						<e:msgdialog basepath="<%=basepath%>"
							callback="window.parent.closeDialogm('add_coupon_m');window.parent.refreshGrid('coupon');">
							${meg}
						</e:msgdialog>
					</c:if>
