...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_streaming/updatetStreaming.action" enctype="multipart/form-data" method="post">
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>" 
  		callback="window.parent.closeDialogm('edit_streaming_m');window.parent.refreshGrid('streaming');
	">
		${meg}
	</e:msgdialog>
</c:if>
