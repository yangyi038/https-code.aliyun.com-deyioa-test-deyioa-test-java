...
<div class="modal-real-body">
	<form
		action="<%=basepath%>/admin/t_stb_group/updateStbGroupById.action"
		enctype="multipart/form-data" method="post">

		<input id="sid" type="hidden" name="sid" value="${t_stb_group.sid}" />
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>"
		callback="window.parent.closeDialogm('edit_t_stb_group_m');window.parent.refreshGrid('t_stb_grouplist');">
							${meg}
	</e:msgdialog>
</c:if>
<script type="text/javascript">
