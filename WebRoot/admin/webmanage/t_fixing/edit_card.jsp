...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_fixing/updatetCard.action" enctype="multipart/form-data" method="post">
			...
			<div class="admin-s-body"> <span>LastIP:</span> <div class="admin-s"> <input type="text" name="lastIp"  style="width:220px;" value="${card.lastIp}"/> </div> </div>  
       		<input type="text" name="id" value="${card.id}" style="visibility:hidden;"/> 
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>" 
  		callback="window.parent.closeDialogm('edit_card_m');window.parent.refreshGrid('card');
	">
		${meg}
	</e:msgdialog>
</c:if>
