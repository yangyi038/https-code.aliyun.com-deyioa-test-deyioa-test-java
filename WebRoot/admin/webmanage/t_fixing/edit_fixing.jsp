...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_fixing/updatetFixing.action" enctype="multipart/form-data" method="post">
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>" 
  		callback="window.parent.closeDialogm('edit_fixing_m');window.parent.refreshGrid('fixing');
	">
		${meg}
	</e:msgdialog>
</c:if>
