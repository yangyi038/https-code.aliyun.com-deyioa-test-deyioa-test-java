...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_imageText/addVideo.action" enctype="multipart/form-data" method="post">
			...
			<div class="admin-s-body"> <span><font style="color:red;">*</font>播放地址:</span> <div class="admin-s"> <input type="text" name="url"  /></div> </div> <br/>
			  <input type="text" name="imagetextId" style="visibility:hidden;" value="${model.id}"/><br/>
