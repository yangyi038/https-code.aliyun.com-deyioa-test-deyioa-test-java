...
height:200px;
	...
	<form action="<%=basepath%>/admin/originplace/addOriginplace.action" enctype="multipart/form-data" method="post"> 
      	<div class="admin-s-body">
       		<span><b style="color: red;">*</b>产地</span>
       		<div class="admin-s"><input type="text" name="name"   id="name"  placeholder="请输入产地"  /></div>
       	</div>
					...
					<c:if test="${meg!=null}">
						<e:msgdialog basepath="<%=basepath%>"
							callback="window.parent.closeDialogm('add_originplace_m');window.parent.refreshGrid('listOriginplace');">
							${meg}
						</e:msgdialog>
					</c:if>
