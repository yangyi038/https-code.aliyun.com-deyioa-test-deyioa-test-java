...
用户名：<input type="text"   name="username"   id="username"> 
						...
						<div class="yz-frame-body">
							<div class="table-box">
								<tgrid:jqGrid url="listBackOrdert.action" autowidth="true"
									dourl="delBackOrdert.action" id="backorderlist" mtype="POST"
...
<e:yzactbutton onclick="pay" title="打款处理"  />    
</e:yzact>
  ...
  function pay(id){
	  var rd =jQuery("#backorderlist").getRowData(id);
		jQuery().yzIframeDialog({id:"dk_orderinfo_m",iframeurl:"<%=basepath%>/admin/backorder/DkBackOrder.action?back_id="+rd['BACK_ID'],title:"打款",width:200});
