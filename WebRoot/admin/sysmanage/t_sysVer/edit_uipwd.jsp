...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_sysVer/updateUiPwd.action" enctype="multipart/form-data" method="post">
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>" 
  		callback="window.parent.closeDialogm('edit_uipwd_m');window.parent.refreshGrid('uipwd');
