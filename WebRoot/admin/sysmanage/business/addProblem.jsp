...
<div class="modal-real-body">
	<form action="<%=basepath%>/admin/problem/addproblem.action"
		...
		<div class="admin-s-body">
			<span class="top"><font style="color: red;">*</font>答案:</span>
			<div class="admin-s">
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>"
		callback="window.parent.closeDialogm('add_problem_m');window.parent.refreshGrid('problemText');">
		${meg}
	</e:msgdialog>
</c:if>
<script type="text/javascript">
