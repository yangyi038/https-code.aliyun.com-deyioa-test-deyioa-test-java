...
<div class="modal-real-body" >
       		...
       		<div class="admin-s-body"> <span>参数名称:</span> <div class="admin-s"> 
		    	 <input type="text" name="name"  id="name" style="width:260px;"  value="${model.name}"/>
		    </div> </div>  <br/>        
	
		    <div class="admin-s-body"> <span>参数值:</span> <div class="admin-s"> 
		    ...
		    <div class="admin-s-body"> <span>参数类型:</span> <div class="admin-s"> 
		   		<input type="text" name="parameterType"  id="parameterValue" style="width:260px;"  value="${model.parameterType}"/>
		    </div> </div> <br/> 
		    
		    <div class="admin-s-body"> <span>创建时间:</span> <div class="admin-s"> 
		   		<input type="text" name="parameterType"  id="parameterValue" style="width:260px;"  value="${model.tempTime}"/>
		    </div> </div> <br/> 
