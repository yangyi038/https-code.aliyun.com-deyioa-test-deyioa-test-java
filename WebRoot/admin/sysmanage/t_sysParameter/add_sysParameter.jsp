...
<div class="modal-real-body" >
	<form action="<%=basepath%>/admin/t_sysParameter/addSysParameter.action" enctype="multipart/form-data" method="post">
	
		    <div class="admin-s-body"> <span><font style="color:red;">*</font>参数名称:</span> <div class="admin-s"> 
		    	 <input type="text" name="name"  id="name" style="width:260px;"/>
		    </div> </div>  <br/>        
	
		    <div class="admin-s-body"> <span><font style="color:red;">*</font>参数值:</span> <div class="admin-s"> 
		    	<input type="text" name="parameterValue"  id="parameterValue" style="width:260px;"/>
		    </div> </div> <br/>
		    
		     <div class="admin-s-body"> <span>参数类型:</span> <div class="admin-s"> 
		    	<select  name="parameterType" id="parameterType" style="width:260px;"/>
		    		<option >字符</option>
 		 			<option >数字</option>
		   		</select> 
		    </div> </div> <br/> 
		    ...
		    <div class="admin-s-body"> <span>描述:</span> <div class="admin-s"> 
		   		 <textarea rows="3" cols="2" type="text" name="sysDescribe" style="width:260px;"></textarea> 
		    </div> </div> <br/>
...
<c:if test="${meg!=null}">
	<e:msgdialog basepath="<%=basepath%>" 
  		callback="window.parent.closeDialogm('add_t_sys_s');window.parent.refreshGrid('sysParameter');
